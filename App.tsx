...
const App: React.FC = () => {
  ...
  return (
    <div className={isDarkMode ? "dark" : ""}>
      <div className="flex bg-slate-50 dark:bg-transparent font-sans min-h-screen text-slate-900 dark:text-slate-100 transition-colors duration-300 relative overflow-hidden">
